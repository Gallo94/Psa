...
switch ($dlevel) {
    ...
    case 'IN':
        ...
        {
            // DA ESEGUIRE SOLO DOPO L'IMPORTAZIONE DEL DB
            // QUERY RESET VALORE RAGGIUNTO INIZIALE
            // aggiorna_indicatore($client, $record->get("e.cod"), "2019-08-28");
            // evaluate_perc_in($client, $record->get('e.cod'), "2019-08-28", 0);
            // evaluate_perc_in($client, $record->get('e.cod'), "2023-12-31", 1);
